...
var Shortcuts = /** @class */ (function (_super) {
    ...
    Shortcuts.prototype.render = function () {
        ...
        var shortcutElements = shortcuts.map(function (s, i) { return (react_1.default.createElement(core_1.MenuItem, { className: core_1.Classes.POPOVER_DISMISS_OVERRIDE, disabled: !_this.isShortcutInRange(s.dateRange), key: i, onClick: _this.getShorcutClickHandler(s.dateRange), text: s.label })); });
